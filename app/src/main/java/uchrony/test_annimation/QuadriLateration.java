...
public class QuadriLateration {
    ...
    private Point trilaterationCDA() { // a-c  c-d  d-a
        double W, Z, foundBeaconLat, foundBeaconLong, foundBeaconLongFilter;
        W = distanceBeaconC * distanceBeaconC - distanceBeaconD * distanceBeaconD - positionBeaconC.x * positionBeaconC.x - positionBeaconC.y * positionBeaconC.y + positionBeaconD.x * positionBeaconD.x + positionBeaconD.y * positionBeaconD.y;
        Z = distanceBeaconD * distanceBeaconD - distanceBeaconA * distanceBeaconA - positionBeaconD.x * positionBeaconD.x - positionBeaconD.y * positionBeaconD.y + positionBeaconA.x * positionBeaconA.x + positionBeaconA.y * positionBeaconA.y;

        foundBeaconLat = (W * (positionBeaconA.y - positionBeaconD.y) - Z * (positionBeaconD.y - positionBeaconC.y)) / (2 * ((positionBeaconD.x - positionBeaconC.x) * (positionBeaconA.y - positionBeaconD.y) - (positionBeaconA.x - positionBeaconD.x) * (positionBeaconD.y - positionBeaconC.y)));
        foundBeaconLong = (W - 2 * foundBeaconLat * (positionBeaconD.x - positionBeaconC.x)) / (2 * (positionBeaconD.y - positionBeaconC.y));
        //'foundBeaconLongFilter` is a second measure of `foundBeaconLong` to mitigate errors
        foundBeaconLongFilter = (Z - 2 * foundBeaconLat * (positionBeaconA.x - positionBeaconD.x)) / (2 * (positionBeaconA.y - positionBeaconD.y));
    ...
    private Point trilaterationBAD() {
        double W, Z, foundBeaconLat, foundBeaconLong, foundBeaconLongFilter;
        W = distanceBeaconB * distanceBeaconB - distanceBeaconA * distanceBeaconA - positionBeaconB.x * positionBeaconB.x - positionBeaconB.y * positionBeaconB.y + positionBeaconA.x * positionBeaconA.x + positionBeaconA.y * positionBeaconA.y;
        Z = distanceBeaconA * distanceBeaconA - distanceBeaconD * distanceBeaconD - positionBeaconA.x * positionBeaconA.x - positionBeaconA.y * positionBeaconA.y + positionBeaconD.x * positionBeaconD.x + positionBeaconD.y * positionBeaconD.y;

        foundBeaconLat = (W * (positionBeaconD.y - positionBeaconA.y) - Z * (positionBeaconA.y - positionBeaconB.y)) / (2 * ((positionBeaconA.x - positionBeaconB.x) * (positionBeaconD.y - positionBeaconA.y) - (positionBeaconD.x - positionBeaconA.x) * (positionBeaconA.y - positionBeaconB.y)));
        foundBeaconLong = (W - 2 * foundBeaconLat * (positionBeaconA.x - positionBeaconB.x)) / (2 * (positionBeaconA.y - positionBeaconB.y));
        //'foundBeaconLongFilter` is a second measure of `foundBeaconLong` to mitigate errors
        foundBeaconLongFilter = (Z - 2 * foundBeaconLat * (positionBeaconD.x - positionBeaconA.x)) / (2 * (positionBeaconD.y - positionBeaconA.y));
    ...
    private void Algo() {
        double W, Z, foundBeaconLat, foundBeaconLong, foundBeaconLongFilter;
        W = Math.pow(distanceBeaconA,2) - Math.pow(distanceBeaconB,2) - Math.pow(positionBeaconA.x,2) - Math.pow(positionBeaconA.y,2) + Math.pow(positionBeaconB.x,2) + Math.pow(positionBeaconB.y,2);
        Z = Math.pow(distanceBeaconB,2) - Math.pow(distanceBeaconC,2) - Math.pow(positionBeaconB.x,2) - Math.pow(positionBeaconB.y,2) + Math.pow(positionBeaconC.x,2) + Math.pow(positionBeaconC.y,2);
